...
<div class="content update">
    ...
    <form action="update-blog.php?id=<?=$post['id']?>" method="post">
        ...
        <input type="text" name="seotitle" placeholder="SEO Title" value="<?=$post['seotitle']?>" id="seotitle">

        <label for="seodesc">SEO Description</label>
        <input type="text" name="seodesc" placeholder="SEO Description" value="<?=$post['seodesc']?>" id="seodesc">

        <label for="seokeyword">SEO Keyword</label>
        <input type="text" name="seokeyword" placeholder="SEO Keyword" value="<?=$post['seokeyword']?>" id="seokeyword">
